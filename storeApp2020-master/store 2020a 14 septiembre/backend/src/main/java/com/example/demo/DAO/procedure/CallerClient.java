...
public class CallerClient extends GetConnectionMySql {
  ...
  public Boolean UserExist_client(String user) throws SQLException {
  ...
  public Boolean PasswordExist_client(String password) throws SQLException {
...
public Boolean isBlocked(String user) throws SQLException {
