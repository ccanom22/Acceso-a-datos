...
public class IndexController {
    ...
    public String index() throws ClassNotFoundException, SQLException {
        ...
        // textHolder.currentRequestAttributes().setAttribute("intentos", "value",
        // scope);)

        if (RequestContextHolder.currentRequestAttributes().getAttribute("activePage",
                RequestAttributes.SCOPE_SESSION) == null) {

            RequestContextHolder.currentRequestAttributes().setAttribute("limit", limit,
            ...
            RequestContextHolder.currentRequestAttributes().setAttribute("recharge", 0,
                    RequestAttributes.SCOPE_SESSION);
